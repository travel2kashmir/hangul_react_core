                                                    ...
                                                    <div className="flex flex-wrap">
                                                        ...
                                                        <div className="w-full lg:w-4/12 px-4">
                                                            <div className="relative w-full mb-3">
                                                                ...
                                                                <button className="bg-red-600 text-white active:bg-red-600 font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none mr-4 mb-1 ease-linear transition-all duration-150" onClick={submitContactDelete} type="button" >Delete</button>
