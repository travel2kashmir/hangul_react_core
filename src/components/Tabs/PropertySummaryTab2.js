                      ...
                      {updatereview === false ?
                        ...
                        <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
                          ...
                          <div className="text-center flex justify-end mt-8"  >
                            ...
                            <button className="bg-lightBlue-600 text-white active:bg-lightBlue-600 font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" onClick={submitReviewEdit} type="button" >Submit</button>
                          </div>
                        </div>
                      }
                    </div>
