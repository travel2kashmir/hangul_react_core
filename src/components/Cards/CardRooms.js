            ...
            <div className="mx-4">
                ...
                <div className="sm:flex">
                    ...
                    <div className="flex items-center space-x-2 sm:space-x-3 ml-auto">
                     ...
                     < Link to="/new-room" className="w-full text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200  font-semibold inline-flex items-center justify-center rounded-lg text-sm px-3 py-2 text-center sm:auto "  >
