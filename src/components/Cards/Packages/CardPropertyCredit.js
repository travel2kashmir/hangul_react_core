          ...
          <li>
            <div className="flex items-center">
              ...
              <Link to={{
                ...
                state: {
                  id: props?.package_property_credit?.package_id
                }
              }} className="text-gray-700 text-sm   font-medium capitalize hover:text-gray-900 ml-1 md:ml-2">{props?.package_property_credit?.package_name}</Link>
            </div>
          </li>
          <li>
            <div className="flex items-center">
