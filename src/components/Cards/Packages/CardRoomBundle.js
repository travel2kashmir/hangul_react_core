      ...
      <nav className="flex mb-5 ml-4" aria-label="Breadcrumb">
        <ol className="inline-flex items-center space-x-1 md:space-x-2">
          ...
          <li>
            <div className="flex items-center">
              <svg className="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
              <span className="text-gray-400 ml-1 md:ml-2 font-medium text-sm  " aria-current="page">Edit Package Room</span>
            </div>
          </li>
        </ol>
      </nav>
                  ...
                  <div className="w-full lg:w-6/12 px-4">
                    <div className="relative w-full mb-3">
                      ...
                      <input
                       ...
                       defaultValue={roomDetails.occupancy} />
                    </div>
                  </div>
                  <div className="w-full lg:w-6/12 px-4">
                    <div className="relative w-full mb-3">
                     ...
                     Number of Adult Guests
                      ...
                      <input
                        type="text"
                        className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5"
                        defaultValue={roomDetails.number_of_adult_guest} />
                    </div>
                  </div>
                    ...
                    focus:ring-4 focus:ring-cyan-200 font-semibold
                     ...
                     mr-1 mb-1 ease-linear transition-all duration-150" type="button" >
                        Update</button>
                    </div>
