...
function CardContact() {
    ...
    return (
        <div>
            ...
            <nav class="flex mb-5 ml-4" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-2">
                    ...
                    <li>
                        <div class="flex items-center">
                            <svg class="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
                            <span class="text-gray-400 ml-1 md:ml-2 font-medium text-sm  " aria-current="page">Contact</span>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            {/* Header */}
            <div class="mx-4">
                <h1 class="text-xl sm:text-2xl font-semibold text-gray-900">Contact</h1>
                <div class="sm:flex">
                    <div class="hidden sm:flex items-center sm:divide-x sm:divide-gray-100 mb-3 sm:mb-0">
                        <form class="lg:pr-3" action="#" method="GET">
                            <label for="users-search" class="sr-only">Search</label>
                            <div class="mt-1 relative lg:w-64 xl:w-96">
                                <input type="text" name="email" id="users-search" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="Search for contacts">
                                </input>
                            </div>
                        </form>
                                            ...
                                            return (
                                                <tr class="hover:bg-gray-100">
                                                    <td class="p-4 flex items-center whitespace-nowrap space-x-6 mr-12 lg:mr-0">
                                                        <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">{item.contact_type} </td>
                                                    </td>
                                                    <td class="p-4 whitespace-nowrap text-base font-medium text-gray-900">{item.contact_data} </td>
            ...
            {/* Modal Edit */}
            <div class="hidden overflow-x-hidden overflow-y-auto fixed top-4 left-0 right-0
                        ...
                        <div class="p-6 space-y-6">
                            <div class="grid grid-cols-6 gap-6">
                                <div class="col-span-6 sm:col-span-3">
                                    <label for="first-name" class="text-sm font-medium text-gray-900 block mb-2">Contact Name</label>
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    <label for="last-name" class="text-sm font-medium text-gray-900 block mb-2">Contact Type</label>
                ...
                <div class="relative w-full max-w-2xl px-4 h-full md:h-auto">
                    <div class="bg-white rounded-lg shadow relative">
                        ...
                        <div class="p-6 space-y-6">
                            <div class="grid grid-cols-6 gap-6">
                                <div class="col-span-6 sm:col-span-3">
                                    <label for="first-name" class="text-sm font-medium text-gray-900 block mb-2">Contact Type</label>
                                    <select 
                                    onChange={e => onChange(e, contact?.index, 'contact_type')} class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5">
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    <label for="last-name" class="text-sm font-medium text-gray-900 block mb-2">Contact Value</label>
                                    <input type="text" name="last-name" id="last-name"
                                     onChange={e => onChange(e, contact?.index, 'contact_data')} className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" required />
                                </div>
                                </div>
                            </div>
                            ))}
                        <div class="items-center p-6 border-t border-gray-200 rounded-b">
                            ...
                            onClick={submitContactAdd} type="submit">Add contact</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="relative w-full max-w-md px-4 h-full md:h-auto">
                    <div class="bg-white rounded-lg shadow relative">
                        ...
                        <div class="p-6 pt-0 text-center">
                            ...
                            <h3 class="text-xl font-normal text-gray-500 mt-5 mb-6">Are you sure you want to delete this contact?</h3>
