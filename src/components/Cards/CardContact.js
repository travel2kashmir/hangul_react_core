            ...
            <nav className="flex mb-5 ml-4" aria-label="Breadcrumb">
                <ol className="inline-flex items-center space-x-1 md:space-x-2">
                    ...
                    <li>
                        <div className="flex items-center">
                            <svg className="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
                            <span className="text-gray-400 ml-1 md:ml-2 font-medium text-sm  " aria-current="page">Contact</span>
                        </div>
                    </li>
                </ol>
            </nav>
                                                    ...
                                                    <td className="p-4 flex items-center whitespace-nowrap space-x-6
                                                     mr-12 lg:mr-0">
                                                        <td className="p-4 whitespace-nowrap text-base font-medium
                                                         text-gray-900">{item.contact_type} </td>
                                                    </td>
                                                    <td className="p-4 whitespace-nowrap text-base font-medium
                                                     text-gray-900">{item.contact_data} </td>
                ...
                <div className="relative w-full max-w-2xl px-4 h-full md:h-auto">
                    <div className="bg-white rounded-lg shadow relative">
                        ...
                        <div className="p-6 space-y-6">
                            <div className="grid grid-cols-6 gap-6">
                                <div className="col-span-6 sm:col-span-3">
                                    ...
                                    <select 
                                     onChange={(e) => (setAllHotelDetails({ ...allHotelDetails, contact_type: e.target.value }) )}
                                ...
                                <div className="col-span-6 sm:col-span-3">
                                    <label for="last-name" className="text-sm font-medium text-gray-900 block mb-2">Contact Value</label>
                                    <input type="text" id="last-name" 
                                     defaultValue={editContact?.contact_data} 
                                     onChange={ (e) => (setAllHotelDetails({ ...allHotelDetails, contact_data: e.target.value }) )}
                        ...
                        <div className="items-center p-6 border-t border-gray-200 rounded-b">
                            ...
                            onClick={()=>submitContactEdit(editContact?.contact_id)} type="submit">Update</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="relative w-full max-w-md px-4 h-full md:h-auto">
                    <div className="bg-white rounded-lg shadow relative">
                        <div className="flex justify-end p-2">
                            <button type="button" onClick={()=>setDeleteContact(0)} className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center" >
                                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                            </button>
                        </div>
                        ...
                        <div className="p-6 pt-0 text-center">
                            ...
                            <h3 className="text-xl font-normal text-gray-500 mt-5 mb-6">
                                Are you sure you want to delete {editContact?.contact_type} {editContact?.contact_data}?</h3>
                            <button 
                            ...
                            <button 
                            onClick={()=>setDeleteContact(0)} className="text-gray-900 bg-white hover:bg-gray-100 focus:ring-4 focus:ring-cyan-200 border border-gray-200 font-medium inline-flex items-center rounded-lg text-base px-3 py-2.5 text-center" data-modal-toggle="delete-user-modal">
                                No, cancel
                            </button>
                        </div>
                    </div>
